...
Security activity is a list of changes that happened to an account's user profile. It includes changes to password, email, and 2FA authentication setup, among others.
