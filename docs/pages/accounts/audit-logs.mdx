...
Audit logs can be exported in the following file formats: CSV, JSON, and JSONL from the page in **Account settings** > [**Audit logs**](https://expo.dev/accounts/[account]/settings/audit-logs).
